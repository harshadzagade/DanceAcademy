...
<div class="about">
	<form method="POST" action="final_valid.php">
			<div class="input_field radio_option" style="color: white">Select Your Program
              <input type="radio" name="radiogroup1" value=" Urban PTP "> 
              Urban PTP
			
              <input type="radio" name="radiogroup1" value="Hip Hop PTP " > 
              Hip Hop PTP
		
			  <input type="radio" name="radiogroup1" value="Breaking PTP " > 
			  Breaking PTP
            ...
            <div class="input_field select_option" style="color: white">Select Your Session&nbsp;
                <select name="s1">
                  <option value="Sat-Sun 6 to 7:30PM">Sat-Sun 6 to 7:30PM</option>
                  <option value="Sat-Sun 8 to 9:30PM" >Sat-Sun 8 to 9:30PM</option>
                </select>
                <div class="select_arrow"></div>
            </div><br><br>
			<div class="input_field radio_option" style="color: white">Fees:-&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <input type="radio" name="radiogroup2" value="17700" checked> 17700
